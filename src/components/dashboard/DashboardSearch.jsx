...
const DashboardSearch = () => {
  return (
    <div className="flex justify-end items-center">
      <div className="md:w-[500px] w-[300px] bg-[#F5F7F7] flex justify-between items-center rounded-small md:pl-3 pl-1.5">
        ...
        <div className=" md:w-[350px] w-[200px]">
          <input
            placeholder="Search"
            className="md:w-[380px] w-[210px] outline-none text-sm bg-[#F5F7F7] h-4 text-white/50 pl-2 caret-customGrey "
          />
        </div>
